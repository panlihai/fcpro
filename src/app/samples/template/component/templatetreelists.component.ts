...
@Component({
  ...
  :host ::ng-deep .templateformtreelists .fc-full>.fc-content{
    height:100%;
  }
  ...
  .templateformtreelists .list-search-every1 {
    width: 15%;
  }
  .templateformtreelists .list-search-every2 {
    width: 20%;
  }
  .templateformtreelists .list-search-every4 {
    width: 25%;
  }
  .templateformtreelists .list-search-every5 {
    width: 40%;
    line-height:27px;
    text-align:right;
  }
...
export class TemplatetreelistsComponent extends ComponentParent {
  treeSelectObj: any = {};

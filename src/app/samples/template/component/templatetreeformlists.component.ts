...
@Component({
  ...
  styles: [`
  :host ::ng-deep .templateformtreeformlists .fc-full>.fc-content{
    height:100%;
  }
  ...
  .templateformtreeformlists .list-search-every1 {
    width: 15%;
  }
  .templateformtreeformlists .list-search-every2 {
    width: 20%;
  }
  .templateformtreeformlists .list-search-every4 {
    width: 25%;
  }
  .templateformtreeformlists .list-search-every5 {
    width: 40%;
    line-height:27px;
  }`]
})

...
@Component({
    selector: 'templateformfastposition',
    templateUrl: './templateformfastposition.component.html',
    styles: [`
      :host ::ng-deep .templateformfastposition .fc-full{
        width: 100%;
        height: auto;
    }
  `]
})
export class TemplateformfastpositionComponent extends ComponentParent {
    //自定义下拉单选

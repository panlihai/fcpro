...
import { TemplateformfastpositionComponent } from './component/templateformfastposition.component';
...
export const templateRouters: Routes = [
    {
        ...
        path: 'system/templateformfastposition',//表单快速定位模板
        component: TemplateformfastpositionComponent
    }, {
        ...
        path: 'system/templatelist',//树列表模板

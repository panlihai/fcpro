...
@Component({
  selector: 'addrowattrvaluedialog',
  template: `
    <div>
      <div class="bg-dialog-content">
        <fc-layoutcol fcSpans="4,6">
          <div class="bg-dialog-left" fccontent1>
          <fc-layoutgroup fcTitle="行属性" class="bg-dialog-left-layoutgroup">
            ...
            <div class="bg-dialog-list3" fccontent>
              <div class="bg-dialog-list3-filter">
                <fc-text class="bg-dialog-filter" fcLabel="行属性1" name="name1"></fc-text>
            ...
            <div class="bg-dialog-list3" fccontent>
              <div class="bg-dialog-list3-filter">
                <fc-text class="bg-dialog-filter" fcLabel="行属性2" name="name2"></fc-text>
                <fc-button class="bg-dialog-btn" fcLabel="过滤" fcType="primary"></fc-button>
              </div>
              <div class="bg-dialog-list3-list">
                <fc-listdata fcAppid="SYSAPP" [fcOption]="rowattrOption"></fc-listdata>
            ...
            <div class="bg-dialog-list3" style="border-bottom:0;" fccontent>
              <div class="bg-dialog-list3-filter">
                <fc-text class="bg-dialog-filter" fcLabel="行属性3" name="name3"></fc-text>
                <fc-button class="bg-dialog-btn" fcLabel="过滤" fcType="primary"></fc-button>
              </div>
              <div class="bg-dialog-list3-list">
                <fc-listdata fcAppid="SYSAPP" [fcOption]="rowattrOption"></fc-listdata>
...
export class AddrowattrvaluedialogComponent {
  _lastPwd: string;
  _newPwd: string;
  @Input()
  lastPwd: string;

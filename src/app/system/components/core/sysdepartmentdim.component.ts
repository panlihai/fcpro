  ...
  <ng-template #companydim style="z-index:999;">
    <fc-layoutpanel fcFull="true">
        ...
        <fc-layoutcol fcSpans="1,1" fccontent>
            <fc-text fccontent1 style="flex:1"  [(ngModel)]="saveObj.SDIM_CODE"  fcLabel="编号" name="TITLE"></fc-text>
            <fc-text fccontent2 style="flex:1"  [(ngModel)]="saveObj.SDIM_NAME" fcLabel="名称" name="PUBLISHUSER" ></fc-text>
...
export class SysdepartmentdimComponent extends ParentlistComponent {
    arr : any = {};
    saveObj: any  = {};
    ztQueryObj:any={};
  //   新增模态框开始
  ...
  componentEvents(type: string, ev: any) {
    ...
    constructor(public mainService: SysdepartmentdimService,
